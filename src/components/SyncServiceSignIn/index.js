...
import LocalLogo from './localhost.png';
...
export default class SyncServiceSignIn extends PureComponent {
    constructor(props) {
        ...
        _.bindAll(this, ['handleDropboxClick', 'handleGoogleDriveClick', 'handleLocalClick']);
    }
    ...
    handleLocalClick() {
        persistField('authenticatedSyncService', 'Local');
    }
    ...
    render() {
        return (
            <div className="sync-service-sign-in-container">
                ...
                <div className="sync-service-container" onClick={this.handleLocalClick}>
